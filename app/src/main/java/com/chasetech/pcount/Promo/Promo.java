...
public class Promo {
    ...
    public Promo(int promoId, String barcode, String desc, String category, String brand, String division, String subcate, int ig, int conversion, double fsovalue, int webid, int multi, boolean update, String otherbarc, int minimumStocks)
    {
        this.id = promoId;
