...
public class PCount {
    ...
    public PCount(int pcountid, String barcode, String desc, String category, String brand, String division, String subcate, int ig, int conversion, double fsovalue, int webid, int multi, String otherbarc, int mins, boolean isupdated, int oldIg, int osatag, int npitag, int counter)
    {
        this.id = pcountid;
